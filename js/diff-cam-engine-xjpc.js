/*
This is a fork of diff-cam-engine Copyright (c) 2016 Will Boyd
https://github.com/lonekorean/diff-cam-engine
diff-cam-engine is released under the MIT license: http://opensource.org/licenses/MIT

2018-12-20 JPC fork
Add variable and property "imageMimeType" to give mime options for the canvas toDataURL() method,
especially to enable "image/jpeg" as a bandwidth-saving alternative to the toDataURL() default 
of uncompressed "image/png".
Add variable and property "jpeqQuality" for use with the case imageMimeType == "image/jpeg".
Add variable and property "facingCamera" to manage phone devices with front and rear-facing cameras
*/
...
var DiffCamEngine = (function () {
    ...
    //2018-12-20 JPC
    var facingCamera;           // string e.g. "environment", or "user" for front-facing camera on phones
    ...
    function init(options) {
        ...
        //2018-12-20
        facingCamera = options.facingCamera || "default";
    ...
    function requestWebcam() {
        //2018-12-20 JPC support facingMode on phones
        var constraints;
        if (facingCamera == "user" || facingCamera == "environment") {
            constraints = {
                audio: false,
                video: { facingMode: facingCamera, width: captureWidth, height: captureHeight }
            };
        } else {
            constraints = {
                audio: false,
        ...
        if (isReadyToDiff) {
            ...
            captureCallback({
                ...
                checkMotionPixel: function (x, y) {
                    //2018-12-16 JPC add semicolon to end of this line
    ...
    function getCaptureUrl(captureImageData) {
        ...
        //2018-12-16 JPC change from default png to much smaller jpeg. ref:
    ...
    return {
        ...
        start: start,
        stop: stop,
        //20181226 JPC add capture to public functions
        capture: capture
    };
})();
